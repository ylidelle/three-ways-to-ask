...
scripts, including the exploratory work this study grew from, do not. This
manuscript's numbers are verified against the results files by a script that
requires each figure to appear in the section claiming it; that checker's own
limitations are documented in its header.
