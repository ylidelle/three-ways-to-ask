...
cannot compound. What occurred: scanning all non-user text in the 64 conversation
...
is exactly this: **49 registered numeric occurrences, each re-read from the file
